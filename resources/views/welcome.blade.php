...
<div class="container">
    <div class="row align-items-center justify-content-center min-vh-75 py-5">
        <div class="col-lg-6 text-center text-lg-start mb-5 mb-lg-0">
            <h1 class="display-3 fw-bold text-dark mb-4">
                Help is just a <span class="text-primary">click</span> away.
            </h1>
            <p class="lead text-secondary mb-5">
                <strong>MasTolongMas</strong> is your premium IT Helpdesk specific solution. 
                Streamline your support requests, track resolutions, and get back to work faster.
            </p>
            <div class="d-flex flex-column flex-sm-row justify-content-center justify-content-lg-start gap-3">
                @auth
                    <a href="{{ route('dashboard') }}" class="btn btn-primary btn-lg px-5 py-3 shadow-lg">Go to Dashboard</a>
                @else
                    <a href="{{ route('login') }}" class="btn btn-primary btn-lg px-5 py-3 shadow-lg">Login</a>
                    <a href="{{ route('register') }}" class="btn btn-outline-secondary btn-lg px-5 py-3">Register</a>
                @endauth
            </div>
        </div>
        <div class="col-lg-6">
            <div class="position-relative">
                <!-- Abstract simple illustration/shape using CSS or SVG -->
                <div class="card border-0 shadow-lg p-4 bg-white" style="transform: rotate(-2deg);">
                    <div class="card-body">
                        <div class="d-flex align-items-center mb-4">
                            ...
                            <h5 class="mb-0 fw-bold">Ticket #2049</h5>
                            <span class="badge bg-success ms-auto">Resolved</span>
                        </div>
                        <h4 class="mb-3">Printer jammed again?</h4>
                        <p class="text-muted mb-4">I've tried restarting it but the paper is stuck deep inside.</p>
                        <hr>
                        <div class="d-flex align-items-center">
                            <div class="avatar bg-gray-200 rounded-circle me-3" style="width: 40px; height: 40px; background-color: #eee;"></div>
                            <div>
                                <small class="d-block text-muted">Assigned to</small>
                                <span class="fw-bold">Mas IT Support</span>
                            </div>
                        </div>
                    </div>
                </div>
                
                <div class="card border-0 shadow-lg p-3 bg-primary text-white position-absolute top-100 start-100 translate-middle" style="width: 200px; transform: rotate(5deg) translate(-50%, -50%); z-index: -1;">
    ...
    <div class="row mt-5 pt-5 text-center">
        <div class="col-md-4 mb-4">
            <div class="card h-100 py-4 hover-shadow">
                <div class="card-body">
                    <div class="mb-3 text-primary">
                        <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="22 12 18 12 15 21 9 3 6 12 2 12"></polyline></svg>
                    </div>
                    <h5 class="fw-bold">Fast Resolution</h5>
                    <p class="text-muted">Track response times and ensure your team is efficient.</p>
                </div>
            </div>
        </div>
        <div class="col-md-4 mb-4">
            <div class="card h-100 py-4 hover-shadow">
                <div class="card-body">
                    ...
                    <h5 class="fw-bold">Detailed Logs</h5>
                    <p class="text-muted">Keep track of every step taken to resolve an issue.</p>
                </div>
            </div>
        </div>
        <div class="col-md-4 mb-4">
            <div class="card h-100 py-4 hover-shadow">
                <div class="card-body">
                    ...
                    <p class="text-muted">Escalate tickets and manage user roles easily.</p>
                </div>
            </div>
        </div>
    </div>
